...
public class PlayerAttack : MonoBehaviour
{
    ...
    public void HandleCombatActions()
    {
        if (Input.GetKeyDown(KeyCode.Alpha1) && CanDrawWeaponOneHanded())
        {
            ...
            animator.SetBool(AnimatorController.Instance.usingWeapon, true);
        ...
        {
            usingOneHanded = false;
            animator.SetBool(AnimatorController.Instance.usingWeapon, false);
        ...
        if (Input.GetKeyDown(KeyCode.Alpha3) && CanDrawWeaponRanged())
        {
            ...
            animator.SetBool(AnimatorController.Instance.usingWeapon, true);
            animator.SetTrigger(AnimatorController.Instance.EquipBow);
        ...
        else if (Input.GetKeyDown(KeyCode.Alpha3) && CanSheatWeaponRanged())
        {
            usingRanged = false;
            animator.SetBool(AnimatorController.Instance.usingWeapon, false);
            animator.SetTrigger(AnimatorController.Instance.DisarmBow);
    ...
    {
        if (Input.GetAxis("Mouse X") < -0.05f && Input.GetAxis("Mouse Y") < 0.15f && Input.GetAxis("Mouse Y") > -0.15f)//coming from right
        {
            animator.SetTrigger(AnimatorController.Instance.InwardSlash);
        }
        else if (Input.GetAxis("Mouse X") > 0.05f && Input.GetAxis("Mouse Y") < 0.15f && Input.GetAxis("Mouse Y") > -0.15f)//coming from left
        {
            animator.SetTrigger(AnimatorController.Instance.OutwardSlash);
        }
        else if (Input.GetAxis("Mouse Y") < -0.05f && Input.GetAxis("Mouse X") < 0.15f && Input.GetAxis("Mouse X") > -0.15f)//coming down from above
        {
            animator.SetTrigger(AnimatorController.Instance.DownwardSlash);
        }
    }
    ...
    {
        animator.ResetTrigger(AnimatorController.Instance.Sheat);//improper fix: 
